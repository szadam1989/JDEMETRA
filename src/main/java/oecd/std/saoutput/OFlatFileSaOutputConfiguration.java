 ...
 */
public class OFlatFileSaOutputConfiguration implements IPropertyDescriptors, Cloneable {
    ...
    @Override
    public Object clone() {
        OFlatFileSaOutputConfiguration clone;
        try {
            clone = (OFlatFileSaOutputConfiguration) super.clone();
            return clone;
        }
